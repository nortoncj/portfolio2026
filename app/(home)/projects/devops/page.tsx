...
/**
 * DevOpsCategoryPage.tsx
 * ─────────────────────────────────────────────────────────────
 * React + TypeScript category page for DevOps & Cloud Engineering.
 * Design system: globals.css tokens — primary accent: blue #78dce8
 * Animations: Framer Motion
 * SEO: schema.org ItemList + BreadcrumbList + Person knowsAbout
 * ─────────────────────────────────────────────────────────────
 * Dependencies:
 *   npm install framer-motion
 *   Place at: app/projects/devops/page.tsx
 */
...
const T = {
  ...
  coral: "#ffd866",
  mint: "#a9dc76",
  blue: "#78dce8", // ← PRIMARY DevOps accent
  ...
  // DevOps primary accent tokens
  cat: "#78dce8",
  catRgb: "120,220,232",
  catDark: "#4ec9df",
  catGlow: "rgba(120,220,232,0.28)",
  // Gradients
  gradPrimary: "linear-gradient(135deg,#78dce8 0%,#ab9df2 60%,#a9dc76 100%)",
  gradDev: "linear-gradient(135deg,#78dce8,#a9dc76)",
  gradCool: "linear-gradient(135deg,#ab9df2,#78dce8)",
  gradWarm: "linear-gradient(135deg,#78dce8,#ffd866)",
} as const;
...
const SKILLS: Skill[] = [
  ...
  },
  {
    ...
    levelLabel: "Advanced",
    category: "orchestration",
    tags: ["templating", "releases", "values", "hooks"],
    yearsExp: 3,
  },
  {
    id: "aws",
    ...
    levelLabel: "Advanced",
    category: "cloud",
    tags: ["ec2", "s3", "ecs", "rds", "iam", "cloudwatch"],
    yearsExp: 4,
  },
  {
    id: "azure",
    ...
    category: "cloud",
    tags: ["aks", "azure-devops", "blob", "functions", "ad"],
    yearsExp: 3,
  },
  {
    id: "terraform",
    ...
    levelLabel: "Advanced",
    category: "iac",
    tags: ["hcl", "modules", "state", "workspaces", "providers"],
    yearsExp: 4,
  },
  {
    id: "ansible",
    ...
    levelLabel: "Advanced",
    category: "iac",
    tags: ["playbooks", "roles", "inventory", "vault", "idempotent"],
    yearsExp: 3,
  },
  {
    id: "github-actions",
    ...
    levelLabel: "Expert",
    category: "cicd",
    tags: ["workflows", "runners", "secrets", "matrix", "reusable"],
    yearsExp: 4,
  },
  {
    id: "argocd",
    ...
    levelLabel: "Advanced",
    category: "cicd",
    tags: ["gitops", "sync", "app-of-apps", "rollback", "waves"],
    yearsExp: 2,
  },
  {
    id: "prometheus",
    ...
    levelLabel: "Advanced",
    category: "monitoring",
    tags: ["metrics", "alertmanager", "dashboards", "exporters", "promql"],
    yearsExp: 3,
  },
  {
    id: "linux",
    ...
    levelLabel: "Expert",
    category: "linux",
    tags: ["systemd", "cron", "networking", "bash", "debian", "alpine"],
    yearsExp: 6,
  },
  {
    id: "nginx",
    ...
    levelLabel: "Expert",
    category: "linux",
    tags: ["reverse-proxy", "ssl", "load-balancing", "traefik", "certs"],
    yearsExp: 5,
  },
];
...
const LevelBadge: React.FC<{ label: string }> = ({ label }) => {
  const colors: Record<string, { bg: string; color: string }> = {
    Expert: { bg: "rgba(120,220,232,.18)", color: T.blue },
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        border: "1px solid rgba(120,220,232,.15)",
        backdropFilter: "blur(12px)",
        boxShadow:
          "0 2px 12px var(--pg-chip), 0 0 0 1px rgba(120,220,232,.06)",
    ...
    >
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: 4, marginTop: 4 }}>
        {skill.tags.slice(0, 3).map((tag) => (
          <a
            key={tag}
            href={`/projects/devops/skill/${tag}`}
            style={{
              padding: "2px 8px",
              borderRadius: 6,
              fontSize: "0.66rem",
              fontFamily: "'JetBrains Mono',monospace",
              background: "rgba(120,220,232,.07)",
              border: "1px solid rgba(120,220,232,.18)",
              color: T.silver,
              textDecoration: "none",
            ...
            onMouseEnter={(e) => {
              ...
              el.style.color = T.blue;
              el.style.background = "rgba(120,220,232,.14)";
            }}
            onMouseLeave={(e) => {
              const el = e.currentTarget as HTMLAnchorElement;
              el.style.color = T.silver;
              el.style.background = "rgba(120,220,232,.07)";
            }}
          >
            #{tag}
          </a>
  ...
  return (
    <motion.article
      ...
      style={{
        ...
        overflow: "hidden",
        background: "var(--pg-card)",
        border: "1px solid rgba(120,220,232,.12)",
      ...
      whileHover={{
        y: -7,
        boxShadow: `0 20px 60px rgba(0,0,0,.12), 0 0 30px rgba(${T.catRgb},.2)`,
        borderColor: `rgba(${T.catRgb},.38)`,
      }}
    ...
    >
      ...
      >
        <motion.img
          src={project.image}
          alt={`${project.title} — DevOps and cloud project`}
          loading="lazy"
...
const FilterPill: React.FC<{
  ...
  onClick: () => void;
  color?: string;
}> = ({ label, active, count, onClick, color = T.blue }) => (
  <button
    onClick={onClick}
    aria-pressed={active}
    style={{
      ...
      background: active
        ? `linear-gradient(135deg,${color}22,${T.mint}22)`
        : "var(--pg-card-soft)",
...
const schemaData = {
  ...
  "@graph": [
    ...
    {
      "@type": "ItemList",
      name: "DevOps & Cloud Projects",
      description:
        "Infrastructure, automation, and cloud engineering projects spanning Kubernetes, Terraform, AWS, and CI/CD pipelines.",
      ...
      itemListElement: PROJECTS.map((p, i) => ({
        ...
        item: {
          ...
          url: p.liveUrl ?? `https://yourportfolio.dev/projects/devops/${p.id}`,
    ...
    },
    {
      ...
      jobTitle: "Systems Engineer & DevOps Architect",
  ...
  return (
    <>
      ...
      >
        ...
        <section
          ...
          style={{
            ...
            overflow: "hidden",
            background:
              "linear-gradient(135deg, #1a2030 0%, #1e2535 50%, #151a25 100%)",
          }}
        >
          ...
          {/* Animated blobs — blue/teal/mint palette */}
          <div
            aria-hidden
            style={{
              position: "absolute",
          ...
          >
            <div
              style={{
                ...
                borderRadius: "50%",
                background:
                  "radial-gradient(circle, rgba(120,220,232,.3) 0%, transparent 70%)",
                filter: "blur(80px)",
                animation: "devopsBlob 10s ease-in-out infinite",
              }}
            />
            <div
              style={{
                ...
                borderRadius: "50%",
                background:
                  "radial-gradient(circle, rgba(169,220,118,.22) 0%, transparent 70%)",
                filter: "blur(90px)",
                animation: "devopsBlob 13s ease-in-out infinite reverse",
              }}
            />
            <div
              style={{
                ...
                borderRadius: "50%",
                background:
                  "radial-gradient(circle, rgba(171,157,242,.18) 0%, transparent 70%)",
                filter: "blur(70px)",
                animation: "devopsBlob 16s ease-in-out infinite 4s",
              }}
            />
          </div>

          {/* Dot-grid overlay for that "infra diagram" feel */}
          <div
            aria-hidden
            style={{
              position: "absolute",
              inset: 0,
              backgroundImage: `radial-gradient(circle, rgba(120,220,232,.18) 1px, transparent 1px)`,
          ...
          >
            ...
            <nav aria-label="Breadcrumb" style={{ marginBottom: "1.5rem" }}>
              ...
              >
                {[
                  ...
                  { label: "DevOps", href: "/projects/devops" },
                ].map((crumb, i, arr) => (
                  <li
                    key={crumb.href}
                    itemScope
            ...
            <motion.div
              ...
              style={{
                ...
                padding: "6px 18px",
                borderRadius: 999,
                background: "rgba(120,220,232,.15)",
                border: "1px solid rgba(120,220,232,.35)",
            ...
            >
              Kubernetes clusters, Terraform IaC, GitOps pipelines, and cloud
              architectures that scale without babysitting. Built to survive a 3
              a.m. alert in silence.
            </motion.p>
        ...
        <section
          id="skills"
          aria-label="DevOps and cloud skills"
        ...
        >
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            >
              ...
              >
                Twelve tools tested under real load — not hello-world tutorials.
                Every skill here has survived a production incident.
              </p>
            </motion.div>
        ...
        <section
          id="projects"
          aria-label="DevOps and cloud projects"
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: activeTags.has(tag)
                        ? `rgba(${T.catRgb},.12)`
                        : "var(--pg-card-soft)",
                      color: activeTags.has(tag) ? T.blue : T.silver,
                      transition: "all 0.2s",
                    }}
                  >
                    #{tag}
        ...
        ══════════════════════════════════════════════════════════ */}
        <section
          aria-label="DevOps technology and tag index"
          style={{
            padding: "4rem 2rem",
            background: T.white,
                  ...
                  return (
                    <a
                      ...
                      style={{
                        ...
                        fontFamily: "'JetBrains Mono',monospace",
                        fontWeight: 600,
                        background: "rgba(120,220,232,.06)",
                        border: "1px solid rgba(120,220,232,.18)",
                        color: T.charcoal,
                        textDecoration: "none",
                        transition: "all 0.2s",
                      ...
                      onMouseLeave={(e) => {
                        const el = e.currentTarget as HTMLAnchorElement;
                        el.style.background = "rgba(120,220,232,.06)";
                        el.style.color = T.charcoal;
                        el.style.borderColor = "rgba(120,220,232,.18)";
        ...
        <section
          ...
          style={{
            padding: "7rem 2rem",
            background: "linear-gradient(135deg, #1a2030 0%, #1e2535 100%)",
            textAlign: "center",
            position: "relative",
            overflow: "hidden",
          }}
        >
          ...
          >
            ...
            >
              ...
              >
                Cloud migrations, K8s clusters, CI/CD pipelines, or IaC rewrites
                — I architect it, automate it, and document it so your team can
                own it.
              </p>
              <div
                style={{
      ...
      <style>{`
        ...
        @keyframes devopsBlob {
          0%, 100% { transform: translate(0, 0) scale(1); }
          33%       { transform: translate(4%, 6%) scale(1.05); }
          66%       { transform: translate(-3%, -4%) scale(0.96); }
        }
        @keyframes devopsPulse {
          0%, 100% { opacity: 1; box-shadow: 0 0 6px #78dce8; }
          50%       { opacity: 0.6; box-shadow: 0 0 18px #78dce8; }
        }
        * { -webkit-font-smoothing: antialiased; box-sizing: border-box; }
        html { scroll-behavior: smooth; }
        button:focus-visible, a:focus-visible {
          outline: 2px solid #78dce8;
          outline-offset: 3px;
        }
      `}</style>
    </>
